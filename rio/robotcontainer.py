...
class RobotContainer:
    ...
    def configureButtonBindings(self) -> None:
        ...
        #     )
        # )
        self._joystick.y().whileTrue(self.elevator.move_to_position_with_ff(1.1)) #l1
        self._joystick.a().whileTrue(self.elevator.move_to_position_with_ff(2.1)) #l2
        self._joystick.b().whileTrue(self.elevator.move_to_position_with_ff(3.1)) #l3
        self._joystick.x().whileTrue(self.elevator.move_to_position_with_ff(4)) #l4
        ...
        self._joystick.povUp().onTrue(self.elevator.runOnce(self.elevator.updateAmps(1)))
        self._joystick.povDown().onTrue(self.elevator.runOnce(self.elevator.updateAmps(-1)))
        self._joystick.povRight().onTrue(self.elevator.runOnce(self.elevator.updateAmps(0.5)))
        self._joystick.povLeft().onTrue(self.elevator.runOnce(self.elevator.updateAmps(-0.5)))
        self._joystick.rightBumper().whileTrue(self.elevator.move_up_through_torque())
